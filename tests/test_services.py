...
def test_date_span(sqlite_session_factory):
    session = sqlite_session_factory()
    c = Calendar(2022)
    c.calendar_creator()
    session.add(c)
    ...
    assert valid_dates[0][0] == 2022
    assert valid_dates[0][1] == 2
    assert valid_dates[0][2] == 14
    assert valid_dates[-1][0] == 2022
    assert valid_dates[-1][1] == 2
    assert valid_dates[-1][2] == 17
